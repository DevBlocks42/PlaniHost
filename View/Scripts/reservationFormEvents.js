...
function doReservation(id)
{
    ...
    $.post("/doReservation", {roomid : roomId, debut : dateDebut, fin : dateFin, cPrenom : prenomClient, cNom : nomClient, cEmail : emailClient, cPhone : phoneClient, cguv : legal, invites : persons}, function(data, result)
    {
