<?php
    ...
    //Config
    $database = new Database("127.0.0.1", "dbadmin", "sio", "planihost");
    $SERVER_ROOT = "/";
    ...
    $INSTALL_PASSWORD_HASH = "$2a$12\$Qnlj3A.uMQN8hmCsIgBJbeiuHiPqKpQrwkKMKptCViVVE1d858U4u";//"$2y$10$/fblVWKHOpGyFiP56kk6HeJEAb2CPnq37qkHDhv6vkCPDtXKZ6tVC";
    switch($_GET["route"])
    {
        case "doInstall":
        {
